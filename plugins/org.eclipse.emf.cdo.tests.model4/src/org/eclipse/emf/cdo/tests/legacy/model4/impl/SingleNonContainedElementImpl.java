 ...
 * </copyright>
 *
 * $Id: SingleNonContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class SingleNonContainedElementImpl extends EObjectImpl implements SingleNonContainedElement
{
  ...
  {
    eFireRead(model4Package.SINGLE_NON_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.SINGLE_NON_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
  ...
  {
    eFireRead(model4Package.SINGLE_NON_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.SINGLE_NON_CONTAINED_ELEMENT__PARENT);
