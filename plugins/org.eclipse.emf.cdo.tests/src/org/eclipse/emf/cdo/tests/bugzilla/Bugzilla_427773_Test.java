...
public class Bugzilla_427773_Test extends AbstractCDOTest
{
  ...
  private static final IPasswordCredentials USER_1_CREDENTIALS = new PasswordCredentials("user1", "12345".toCharArray());
  ...
  public void setUp() throws Exception
  {
    ...
    getTestProperties().put(SessionConfig.PROP_TEST_CREDENTIALS_PROVIDER,
        new PasswordCredentialsProvider(USER_1_CREDENTIALS));
