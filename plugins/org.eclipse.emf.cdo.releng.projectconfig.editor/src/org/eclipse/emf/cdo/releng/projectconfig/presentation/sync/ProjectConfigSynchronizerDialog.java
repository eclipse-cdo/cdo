    ...
    if (managedPropertiesInput != null)
    {
      ...
      profileViewerColumn.setLabelProvider(new DecoratingColumLabelProvider(labelProvider, new DialogLabelDecorator())
      {
        ...
        private PreferenceFilter getManagingFilter(Property managingProperty)
        {
          ...
          WorkspaceConfiguration workspaceConfiguration = (WorkspaceConfiguration)managingProperty.eResource()
              .getContents().get(0);
      ...
      profileValueViewerColumn.setLabelProvider(new DecoratingColumLabelProvider(labelProvider,
          new DialogLabelDecorator())
      {
        @Override
        public String getText(Object element)
        {
