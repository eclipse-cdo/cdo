...
public class AssemblyItemProviderAdapterFactory extends AssemblyAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
   ...
   * {@link org.eclipse.emf.cdo.lm.assembly.Assembly} instances. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link org.eclipse.emf.cdo.lm.assembly.Assembly}.
   * <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This keeps track of the one adapter used for all
   * {@link org.eclipse.emf.cdo.lm.assembly.AssemblyModule} instances. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  protected AssemblyModuleItemProvider assemblyModuleItemProvider;

  /**
   * This creates an adapter for a
   * {@link org.eclipse.emf.cdo.lm.assembly.AssemblyModule}. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   *
   * @generated
   */
  ...
  {
    if (assemblyModuleItemProvider == null)
    {
      assemblyModuleItemProvider = new AssemblyModuleItemProvider(this);
    }

    return assemblyModuleItemProvider;
  }
  ...
  public void dispose()
  {
    ...
    if (assemblyModuleItemProvider != null)
    {
      assemblyModuleItemProvider.dispose();
    }
  }
}
