 ...
 * </copyright>
 *
 * $Id: ImplMultiRefNonContainerImpl.java,v 1.2 2008-09-18 12:56:48 estepper Exp $
 */
  ...
  public EList<IMultiRefNonContainedElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectWithInverseResolvingEList<IMultiRefNonContainedElement>(IMultiRefNonContainedElement.class,
          ...
          model4interfacesPackageImpl.IMULTI_REF_NON_CONTAINED_ELEMENT__PARENT).readWriteFiringList();
    }
    return elements;
  }
