 ...
 * </copyright>
 *
 * $Id: ImplContainedElementNPLImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplContainedElementNPLImpl extends EObjectImpl implements ImplContainedElementNPL
{
  ...
  {
    eFireRead(model4Package.IMPL_CONTAINED_ELEMENT_NPL__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.IMPL_CONTAINED_ELEMENT_NPL__NAME);
    String oldName = name;
    name = newName;
