 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.FileMappingImpl#getFilePattern <em>File Pattern</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.FileMappingImpl#getDefaultEditorID <em>Default Editor ID</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.FileMappingImpl#getEditors <em>Editors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileMappingImpl extends MinimalEObjectImpl.Container implements FileMapping
{
  ...
  {
    return SetupPackage.Literals.FILE_MAPPING;
  }
  ...
  public void setFilePattern(String newFilePattern)
  {
    ...
    {
      eNotify(new ENotificationImpl(this, Notification.SET, SetupPackage.FILE_MAPPING__FILE_PATTERN, oldFilePattern,
          filePattern));
    }
  }
  ...
  public void setDefaultEditorID(String newDefaultEditorID)
  {
    ...
    if (eNotificationRequired())
    {
      eNotify(new ENotificationImpl(this, Notification.SET, SetupPackage.FILE_MAPPING__DEFAULT_EDITOR_ID,
  ...
  public EList<FileEditor> getEditors()
  {
    if (editors == null)
    {
      editors = new EObjectContainmentEList.Resolving<FileEditor>(FileEditor.class, this,
          SetupPackage.FILE_MAPPING__EDITORS);
    }
    return editors;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
    case SetupPackage.FILE_MAPPING__FILE_PATTERN:
