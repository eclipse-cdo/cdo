 ...
 * </copyright>
 *
 * $Id: ImplSingleRefNonContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplSingleRefNonContainedElementImpl extends EObjectImpl implements ImplSingleRefNonContainedElement
{
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_NON_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_NON_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_NON_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_NON_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
    if (eNotificationRequired())
    {
