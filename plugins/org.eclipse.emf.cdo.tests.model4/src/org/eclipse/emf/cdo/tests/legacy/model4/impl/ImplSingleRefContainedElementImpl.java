 ...
 * </copyright>
 *
 * $Id: ImplSingleRefContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplSingleRefContainedElementImpl extends EObjectImpl implements ImplSingleRefContainedElement
{
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
