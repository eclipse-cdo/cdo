 ...
 * </copyright>
 *
 * $Id: ImplSingleRefContainerNPLImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplSingleRefContainerNPLImpl extends EObjectImpl implements ImplSingleRefContainerNPL
{
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_CONTAINER_NPL__ELEMENT);
    return element;
  }
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_CONTAINER_NPL__ELEMENT);
