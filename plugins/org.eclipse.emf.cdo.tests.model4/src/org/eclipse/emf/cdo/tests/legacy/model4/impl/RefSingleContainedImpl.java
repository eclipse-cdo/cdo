 ...
 * </copyright>
 *
 * $Id: RefSingleContainedImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class RefSingleContainedImpl extends EObjectImpl implements RefSingleContained
{
  ...
  {
    eFireRead(model4Package.REF_SINGLE_CONTAINED__ELEMENT);
    return element;
  }
  ...
  {
    eFireWrite(model4Package.REF_SINGLE_CONTAINED__ELEMENT);
