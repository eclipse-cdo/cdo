...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.cdo.releng.setup.MylynBuildsTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(SetupPackage.Literals.MYLYN_BUILDS_TASK__BUILD_PLANS);
    }
  ...
  public String getText(Object object)
  {
    ...
    return serverURL == null || serverURL.length() == 0 ? getString("_UI_MylynBuildsTask_type") : "" + serverURL + " ("
        + connectorKind + ")";
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add(createChildParameter(SetupPackage.Literals.MYLYN_BUILDS_TASK__BUILD_PLANS,
        SetupFactory.eINSTANCE.createBuildPlan()));
  }
