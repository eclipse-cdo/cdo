 ...
 * </copyright>
 *
 * $Id: ImplMultiRefNonContainerNPLImpl.java,v 1.2 2008-09-18 12:56:48 estepper Exp $
 */
  ...
  public EList<IContainedElementNoParentLink> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectResolvingEList<IContainedElementNoParentLink>(IContainedElementNoParentLink.class, this,
          model4Package.IMPL_MULTI_REF_NON_CONTAINER_NPL__ELEMENTS).readWriteFiringList();
    }
    return elements;
  }
