/*
 * Copyright (c) 2021, 2023, 2025 Ed Merks and others.
...
final class AccessUtil
{
  ...
  private static final Map<String, Object> PACKAGE_ACCESSIBILITY_CONTROL_MAP = Collections.synchronizedMap(new HashMap<>());
