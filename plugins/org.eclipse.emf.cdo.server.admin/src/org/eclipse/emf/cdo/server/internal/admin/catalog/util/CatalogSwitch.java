...
public class CatalogSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    ...
    {
      RepositoryCatalog repositoryCatalog = (RepositoryCatalog)theEObject;
      T result = caseRepositoryCatalog(repositoryCatalog);
      if (result == null)
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Repository Catalog</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Repository Catalog</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRepositoryCatalog(RepositoryCatalog object)
  {
    return null;
  }
