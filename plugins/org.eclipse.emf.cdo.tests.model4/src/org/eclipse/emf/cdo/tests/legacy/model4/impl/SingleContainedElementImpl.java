 ...
 * </copyright>
 *
 * $Id: SingleContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class SingleContainedElementImpl extends EObjectImpl implements SingleContainedElement
{
  ...
  {
    eFireRead(model4Package.SINGLE_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.SINGLE_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
  ...
  {
    eFireRead(model4Package.SINGLE_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.SINGLE_CONTAINED_ELEMENT__PARENT);
