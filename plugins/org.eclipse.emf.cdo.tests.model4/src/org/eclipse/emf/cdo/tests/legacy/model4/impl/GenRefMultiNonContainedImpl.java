 ...
 * </copyright>
 *
 * $Id: GenRefMultiNonContainedImpl.java,v 1.2 2008-09-18 12:56:48 estepper Exp $
 */
...
public class GenRefMultiNonContainedImpl extends EObjectImpl implements GenRefMultiNonContained
{
  ...
  public EList<EObject> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectResolvingEList<EObject>(EObject.class, this,
          model4Package.GEN_REF_MULTI_NON_CONTAINED__ELEMENTS).readWriteFiringList();
    }
    return elements;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
    case model4Package.GEN_REF_MULTI_NON_CONTAINED__ELEMENTS:
      return getElements();
    }
