...
public class Class1Impl extends EObjectImpl implements Class1
{
  ...
  public EList<Class2> getClass2()
  {
    if (class2 == null)
    {
      class2 = new EObjectWithInverseResolvingEList.ManyInverse<Class2>(Class2.class, this,
          Model3Package.CLASS1__CLASS2, SubpackagePackage.CLASS2__CLASS1).readWriteFiringList();
    }
    return class2;
  }
  ...
  public boolean eIsSet(int featureID)
  {
    ...
    {
    case Model3Package.CLASS1__CLASS2:
      return class2 != null && !class2.isEmpty();
    }
