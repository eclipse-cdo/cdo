/*
 * Copyright (c) 2009-2013, 2015, 2016, 2019, 2020, 2023-2025 Eike Stepper (Loehne, Germany) and others.
...
public final class CDONet4jUtil
{
  ...
  {
    return createFailoverSessionConfiguration(monitorConnectorDescription, repositoryGroup, IManagedContainer.INSTANCE);
  }
