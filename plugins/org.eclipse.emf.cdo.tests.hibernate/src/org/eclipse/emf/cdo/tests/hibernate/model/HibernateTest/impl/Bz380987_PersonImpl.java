...
public class Bz380987_PersonImpl extends EObjectImpl implements Bz380987_Person {
	...
	public EList<Bz380987_Group> getGroup() {
		if (group == null) {
			group = new EObjectWithInverseResolvingEList.ManyInverse<Bz380987_Group>(Bz380987_Group.class, this, HibernateTestPackage.BZ380987_PERSON__GROUP, HibernateTestPackage.BZ380987_GROUP__PEOPLE);
		}
		return group;
	}
	...
	public EList<Bz380987_Place> getPlaces() {
		if (places == null) {
			places = new EObjectWithInverseResolvingEList.ManyInverse<Bz380987_Place>(Bz380987_Place.class, this, HibernateTestPackage.BZ380987_PERSON__PLACES, HibernateTestPackage.BZ380987_PLACE__PEOPLE);
		}
		return places;
	}
