/*
 * Copyright (c) 2012, 2013, 2015-2017, 2019, 2020, 2023, 2025 Eike Stepper (Loehne, Germany) and others.
...
public abstract class DBOfflineConfig extends OfflineConfig
{
  ...
  protected Map<String, String> createMappingStrategyProperties()
  {
    ...
    props.put(IMappingStrategy.Props.QUALIFIED_NAMES, Boolean.TRUE.toString());
