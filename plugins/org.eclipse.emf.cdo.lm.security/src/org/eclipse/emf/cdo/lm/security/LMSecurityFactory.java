...
public interface LMSecurityFactory extends EFactory
{
   ...
   * @generated
   */
  LMSecurityFactory eINSTANCE = org.eclipse.emf.cdo.lm.security.impl.LMSecurityFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Module Type Filter</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Module Type Filter</em>'.
   * @generated
   */
