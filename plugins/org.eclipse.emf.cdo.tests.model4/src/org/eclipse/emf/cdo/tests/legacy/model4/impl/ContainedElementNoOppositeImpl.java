 ...
 * </copyright>
 *
 * $Id: ContainedElementNoOppositeImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ContainedElementNoOppositeImpl extends EObjectImpl implements ContainedElementNoOpposite
{
  ...
  {
    eFireRead(model4Package.CONTAINED_ELEMENT_NO_OPPOSITE__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.CONTAINED_ELEMENT_NO_OPPOSITE__NAME);
    String oldName = name;
    name = newName;
