 ...
 * </copyright>
 *
 * $Id: RefSingleNonContainedImpl.java,v 1.2 2008-09-18 12:56:48 estepper Exp $
 */
...
public class RefSingleNonContainedImpl extends EObjectImpl implements RefSingleNonContained
{
  ...
  {
    eFireRead(model4Package.REF_SINGLE_NON_CONTAINED__ELEMENT);
  ...
  {
    eFireWrite(model4Package.REF_SINGLE_NON_CONTAINED__ELEMENT);
