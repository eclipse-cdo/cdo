 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.SourceLocatorImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.SourceLocatorImpl#getComponentNamePattern <em>Component Name Pattern</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.SourceLocatorImpl#getComponentTypes <em>Component Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SourceLocatorImpl extends MinimalEObjectImpl.Container implements SourceLocator
{
  /**
  ...
  {
    return SetupPackage.Literals.SOURCE_LOCATOR;
  }
  ...
  public EList<ComponentType> getComponentTypes()
  {
    if (componentTypes == null)
    {
      componentTypes = new EDataTypeUniqueEList<ComponentType>(ComponentType.class, this,
          SetupPackage.SOURCE_LOCATOR__COMPONENT_TYPES);
    }
