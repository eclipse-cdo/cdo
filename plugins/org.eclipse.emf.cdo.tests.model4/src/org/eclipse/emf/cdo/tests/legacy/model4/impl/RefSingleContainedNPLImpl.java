 ...
 * </copyright>
 *
 * $Id: RefSingleContainedNPLImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class RefSingleContainedNPLImpl extends EObjectImpl implements RefSingleContainedNPL
{
  ...
  {
    eFireRead(model4Package.REF_SINGLE_CONTAINED_NPL__ELEMENT);
    return element;
  }
  ...
  {
    eFireWrite(model4Package.REF_SINGLE_CONTAINED_NPL__ELEMENT);
