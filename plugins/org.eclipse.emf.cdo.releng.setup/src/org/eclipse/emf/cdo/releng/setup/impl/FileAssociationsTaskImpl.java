 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.cdo.releng.setup.impl.FileAssociationsTaskImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileAssociationsTaskImpl extends SetupTaskImpl implements FileAssociationsTask
{
  ...
  {
    return SetupPackage.Literals.FILE_ASSOCIATIONS_TASK;
  }
  ...
  public EList<FileMapping> getMappings()
  {
    if (mappings == null)
    {
      mappings = new EObjectContainmentEList.Resolving<FileMapping>(FileMapping.class, this,
          SetupPackage.FILE_ASSOCIATIONS_TASK__MAPPINGS);
    }
    return mappings;
  }
  ...
  public void perform(SetupTaskContext context) throws Exception
  {
    ...
    performUI(context, new RunnableWithContext()
    {
      ...
      {
        registry.setFileEditorMappings(fileEditorMappings.values().toArray(
            new FileEditorMapping[fileEditorMappings.size()]));
