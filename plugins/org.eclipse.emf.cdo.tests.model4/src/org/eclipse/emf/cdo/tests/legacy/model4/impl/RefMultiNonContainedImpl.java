 ...
 * </copyright>
 *
 * $Id: RefMultiNonContainedImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class RefMultiNonContainedImpl extends EObjectImpl implements RefMultiNonContained
{
  ...
  public EList<MultiNonContainedElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentWithInverseEList<MultiNonContainedElement>(MultiNonContainedElement.class, this,
