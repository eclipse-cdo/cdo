...
public class UnorderedListImpl extends EObjectImpl implements UnorderedList
{
  ...
  public EList<UnorderedList> getContained()
  {
    if (contained == null)
    {
      contained = new EObjectContainmentEList.Resolving<>(UnorderedList.class, this, Model6Package.UNORDERED_LIST__CONTAINED);
    }
    return contained;
  }
  ...
  public EList<UnorderedList> getReferenced()
  {
    if (referenced == null)
    {
      referenced = new EObjectResolvingEList<>(UnorderedList.class, this, Model6Package.UNORDERED_LIST__REFERENCED);
    }
    return referenced;
  }
