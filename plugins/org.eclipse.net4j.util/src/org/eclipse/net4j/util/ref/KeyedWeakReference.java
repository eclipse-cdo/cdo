/*
 * Copyright (c) 2007, 2009, 2011, 2012, 2015, 2016, 2019, 2023, 2025 Eike Stepper (Loehne, Germany) and others.
...
public class KeyedWeakReference<K, T> extends WeakReference<T> implements KeyedReference<K, T>
{
  ...
  {
    return MessageFormat.format("KeyedWeakReference[{0} -> {1}]", key, get()); //$NON-NLS-1$
  }
}
