/*
 * Copyright (c) 2013, 2018, 2019, 2025 Eike Stepper (Loehne, Germany) and others.
...
public class GenListOfIntImpl extends EObjectImpl implements GenListOfInt
{
  ...
  public EList<Integer> getElements()
  {
    if (elements == null)
    {
      elements = new EDataTypeUniqueEList<>(Integer.class, this, Model5Package.GEN_LIST_OF_INT__ELEMENTS);
    }
    return elements;
  }
