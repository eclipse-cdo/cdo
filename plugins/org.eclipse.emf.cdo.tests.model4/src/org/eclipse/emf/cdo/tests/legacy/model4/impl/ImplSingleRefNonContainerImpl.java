 ...
 * </copyright>
 *
 * $Id: ImplSingleRefNonContainerImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplSingleRefNonContainerImpl extends EObjectImpl implements ImplSingleRefNonContainer
{
  ...
  {
    eFireRead(model4Package.IMPL_SINGLE_REF_NON_CONTAINER__ELEMENT);
  ...
  {
    eFireWrite(model4Package.IMPL_SINGLE_REF_NON_CONTAINER__ELEMENT);
