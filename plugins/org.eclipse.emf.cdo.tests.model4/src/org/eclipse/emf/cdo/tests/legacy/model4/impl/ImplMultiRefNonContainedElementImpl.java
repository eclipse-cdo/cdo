 ...
 * </copyright>
 *
 * $Id: ImplMultiRefNonContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class ImplMultiRefNonContainedElementImpl extends EObjectImpl implements ImplMultiRefNonContainedElement
{
  ...
  {
    eFireRead(model4Package.IMPL_MULTI_REF_NON_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.IMPL_MULTI_REF_NON_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireRead(model4Package.IMPL_MULTI_REF_NON_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.IMPL_MULTI_REF_NON_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
    if (eNotificationRequired())
    {
