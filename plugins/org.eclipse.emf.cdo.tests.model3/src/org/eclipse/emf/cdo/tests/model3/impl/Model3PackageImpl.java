 ...
 * </copyright>
 *
 * $Id: Model3PackageImpl.java,v 1.2.4.1 2008-07-02 10:44:45 estepper Exp $
 */
...
public class Model3PackageImpl extends EPackageImpl implements Model3Package {
	...
	public static Model3Package init() {
		if (isInited)
			return (Model3Package) EPackage.Registry.INSTANCE
					.getEPackage(Model3Package.eNS_URI);

		// Obtain or create and register package
		Model3PackageImpl theModel3Package = (Model3PackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof Model3PackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEReference(getClass1_Class2(), theSubpackagePackage.getClass2(),
				theSubpackagePackage.getClass2_Class1(), "class2", null, 0, -1,
				Class1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
