 ...
 * </copyright>
 *
 * $Id: GenRefSingleContainedImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class GenRefSingleContainedImpl extends EObjectImpl implements GenRefSingleContained
{
  ...
  {
    eFireRead(model4Package.GEN_REF_SINGLE_CONTAINED__ELEMENT);
    return element;
  }
  ...
  {
    eFireWrite(model4Package.GEN_REF_SINGLE_CONTAINED__ELEMENT);
