 ...
 * </copyright>
 *
 * $Id: MultiContainedElementImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class MultiContainedElementImpl extends EObjectImpl implements MultiContainedElement
{
  ...
  {
    eFireRead(model4Package.MULTI_CONTAINED_ELEMENT__NAME);
    return name;
  }
  ...
  {
    eFireWrite(model4Package.MULTI_CONTAINED_ELEMENT__NAME);
    String oldName = name;
    name = newName;
  ...
  {
    eFireRead(model4Package.MULTI_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.MULTI_CONTAINED_ELEMENT__PARENT);
  ...
  {
    eFireWrite(model4Package.MULTI_CONTAINED_ELEMENT__PARENT);
    if (newParent != eInternalContainer() || eContainerFeatureID != model4Package.MULTI_CONTAINED_ELEMENT__PARENT
        && newParent != null)
    {
