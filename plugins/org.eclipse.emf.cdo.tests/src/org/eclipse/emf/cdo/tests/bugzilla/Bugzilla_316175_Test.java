 ...
 *    Victor Roldan Betancort - Adaptation from 3.0 to 2.0
 */
...
/**
 * Bug 316175 - [DB] Revision list values loads NULL (edit)
 * 
 * @author Eike Stepper
 */
public class Bugzilla_316175_Test extends AbstractCDOTest
{
  ...
  protected void doSetUp() throws Exception
  {
    ...
    CDOResource resource = transaction.getOrCreateResource(RESOURCE_NAME);
  ...
  public void testRevisionInListNull()
  {
    CDOSession session = (CDOSession)openSession();
    CDOTransaction transaction = session.openTransaction();
    CDORevision revision = session.getRevisionManager().getRevision(id, 0, true);
    msg(revision);
