/*
 * Copyright (c) 2009-2012, 2014-2016, 2018, 2019, 2021, 2023, 2024 Eike Stepper (Loehne, Germany) and others.
...
public interface CDOTransaction extends CDOView, CDOCommonTransaction, CDOUserTransaction, CDOChangeSetDataProvider
{
  ...
  /**
   * A value type that combines the result of a <i>persistable computation</i> and the {@link CDOCommitInfo commit info}
