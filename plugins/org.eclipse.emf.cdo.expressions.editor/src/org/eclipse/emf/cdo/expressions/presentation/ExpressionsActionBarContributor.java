...
public class ExpressionsActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    //
    createChildMenuManager = new MenuManager(ExpressionsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager)
  {
    ...
    submenuManager = new MenuManager(ExpressionsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(ExpressionsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
