...
public class Doc03_PreparingWorkspace
{
   ...
   * <p>
   * The Oomph Setup Engine is a powerful tool for automating the setup of Eclipse workspaces. It allows you to define a set of
   * provisioning tasks, such as installing plugins, configuring preferences, and setting up projects. On the
   ...
   * <p>
   * For CDO development, you typically want to add a TargletTask that sets up the target platform of your workspace to include the CDO SDK and its dependencies.
   * As a convenience, CDO's build system produces a setup macro that you can reference from your setup file. To do so, you need to find the appropriate
