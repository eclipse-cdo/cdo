/*
 * Copyright (c) 2010-2012, 2019, 2022, 2025 Eike Stepper (Loehne, Germany) and others.
...
public class RevisionDeltaInBranchTest extends RevisionDeltaTest
{
  ...
  protected void testStoreDelta(ListManipulator manipulator)
  {
    ...
    // sub branch - second batch
    {
      CDOSession session = openSession();
      CDOBranch mainBranch = session.getBranchManager().getMainBranch();
      CDOBranch subBranch = mainBranch.createBranch(getBranchName("subBranch"), timestampBaseBranch);
