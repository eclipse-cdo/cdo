...
public class AssemblyAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AssemblySwitch<Adapter> modelSwitch = new AssemblySwitch<Adapter>()
  {
    ...
    @Override
    public Adapter caseAssemblyModule(AssemblyModule object)
    {
      return createAssemblyModuleAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.cdo.lm.assembly.AssemblyModule <em>Module</em>}'.
