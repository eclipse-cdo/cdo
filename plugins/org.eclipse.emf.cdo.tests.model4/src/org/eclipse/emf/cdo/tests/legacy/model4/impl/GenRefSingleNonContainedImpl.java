 ...
 * </copyright>
 *
 * $Id: GenRefSingleNonContainedImpl.java,v 1.2 2008-09-18 12:56:49 estepper Exp $
 */
...
public class GenRefSingleNonContainedImpl extends EObjectImpl implements GenRefSingleNonContained
{
  ...
  {
    eFireRead(model4Package.GEN_REF_SINGLE_NON_CONTAINED__ELEMENT);
  ...
  {
    eFireWrite(model4Package.GEN_REF_SINGLE_NON_CONTAINED__ELEMENT);
