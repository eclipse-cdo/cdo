...
public class AcoreActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
  ...
  {
    toolBarManager.add(new Separator("acore-settings"));
    toolBarManager.add(new Separator("acore-additions"));
  }
  ...
  public void contributeToMenu(IMenuManager menuManager)
  {
    ...
    IMenuManager submenuManager = new MenuManager(AcoreEditorPlugin.INSTANCE.getString("_UI_AcoreEditor_menu"),
        "org.eclipse.emf.cdo.dawn.examples.acoreMenuID");
    ...
    //
    createChildMenuManager = new MenuManager(AcoreEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager = new MenuManager(AcoreEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager)
  {
    ...
    submenuManager = new MenuManager(AcoreEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(AcoreEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
