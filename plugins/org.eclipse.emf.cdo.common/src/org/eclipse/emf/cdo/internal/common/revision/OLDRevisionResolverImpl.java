 ...
 * @author Eike Stepper
 */
public abstract class OLDRevisionResolverImpl extends Lifecycle implements CDORevisionResolver
{
  private static final ContextTracer TRACER = new ContextTracer(OM.DEBUG_REVISION, OLDRevisionResolverImpl.class);
  ...
  public OLDRevisionResolverImpl()
  {
  }
  ...
  public List<CDORevision> getRevisions()
  {
    ...
    {
      CDORevision revision = holder.getRevision();
  ...
  {
    RevisionHolder holder = revisions.get(id);
    InternalCDORevision revision = holder == null ? null : (InternalCDORevision)holder.getRevision();
    if (revision == null || !revision.isCurrent())
    {
      if (loadOnDemand)
      {
      ...
      boolean loadOnDemand)
  {
    ...
    while (holder != null)
    {
      ...
      else if (indicator == 0)
      {
        ...
        InternalCDORevision oldRevision = holder.getRevision();
